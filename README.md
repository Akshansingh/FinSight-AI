...
| ----------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------ |
| AAPL Historical Stock Data    | Yahoo Finance (yfinance)                                                      | Stock price forecasting                    |
| Market OHLCV Data             | Yahoo Finance API                                                             | Feature engineering and technical analysis |
| Technical Indicators Dataset  | Generated using RSI, MACD, Bollinger Bands, SMA, EMA, Returns, and Volatility | Model training                             |
| AAPL_features.csv             | Custom Processed Dataset                                                      | LSTM feature input                         |
| AAPL_training.csv             | Custom Training Dataset                                                       | Sequence generation and model training     |
| Historical Prediction Records | PostgreSQL Database                                                           | Prediction analytics and tracking          |
| Cloud Backup Artifacts        | AWS S3 Bucket                                                                 | Dataset and model storage                  |

### Data Pipeline

Yahoo Finance API
↓
Raw Stock Data (AAPL.csv)
↓
Feature Engineering
├── RSI
├── MACD
...
FinSight AI leverages Amazon Web Services (AWS) to provide scalable and reliable cloud storage for datasets, machine learning artifacts, and prediction resources.

## AWS Services Used

### Amazon S3 (Simple Storage Service)

The platform integrates AWS S3 as a centralized cloud data lake for storing and managing machine learning resources.
...
Local Training Pipeline
 ...
 │        │        │
 ▼        ▼        ▼
Raw Data  Models  Processed Data
```
...
* Downloaded Yahoo Finance data
* CSV market snapshots

### Processed Datasets

* Feature engineered datasets
* Technical indicator datasets
* Training-ready transformed data
...
FinSight AI provides automated cloud backup functionality through FastAPI endpoints.
...
3. FastAPI triggers upload process
4. Files securely uploaded to AWS S3
5. Backup status returned to client
...
* Production-ready cloud workflow
* Separation of training and deployment assets
...
This cloud-based architecture enables FinSight AI to operate as a scalable machine learning platform rather than a standalone local application.
